const translations = {
  en: {
    ...
    "panel.ops_entry": "Ops Capability Entry",
    "panel.ops_entry_hint": "Version development governance pages (workflow/version/detail).",
    ...
    "ops.workflow_link": "Workflow Registry",
    "ops.version_link": "Version Registry",
    "ops.detail_link": "Version Detail (sample)",
    "ops.sources": "Canonical Sources",
    "axis.time": "Time",
    "axis.rate": "Rate (%)",
    "axis.health": "Health (%)",
  ...
  zh: {
    ...
    "panel.ops_entry": "Ops 能力入口",
    "panel.ops_entry_hint": "版本開發治理頁面入口（workflow/version/detail）。",
    ...
    "table.failing": "未通過檢查",
    "data.source": "資料來源",
    "ops.workflow_link": "工作流程清單",
    "ops.version_link": "版本清單",
    "ops.detail_link": "版本詳情（範例）",
    "ops.sources": "權威來源",
    "axis.time": "時間",
    "axis.rate": "比例 (%)",
    "axis.health": "健康度 (%)",
